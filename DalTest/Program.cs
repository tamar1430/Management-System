...
internal class Program
{
    ...
    // this code defines a method that updates an entity based on the provided entity parameter. 
    //It dynamically calls a specific update method based on the value of entity.
    // If any exception occurs during the update operation, it catches the exception and displays its error message.
